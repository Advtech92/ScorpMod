...
public class ItemPurpleBottle extends Item {
	public ItemPurpleBottle() {
		super();
		setUnlocalizedName("purplebottle");
	...
	public ItemStack onEaten(ItemStack par1ItemStack, World par2World,
		...
		if (!par2World.isRemote) {
			par3EntityPlayer.addPotionEffect(new PotionEffect(
					Potion.moveSpeed.id, 1200, 1, true));
			par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.jump.id,
					1200, 1, true));
			par3EntityPlayer.addPotionEffect(new PotionEffect(
					Potion.damageBoost.id, 1200, 1, true));
		}
