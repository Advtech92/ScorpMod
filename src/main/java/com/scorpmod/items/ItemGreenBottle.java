...
public class ItemGreenBottle extends Item {
	public ItemGreenBottle() {
		super();
		setUnlocalizedName("greenbottle");
	...
	public ItemStack onEaten(ItemStack par1ItemStack, World par2World,
		...
		if (!par2World.isRemote) {
			par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.heal.id,
					1, 2, true));
			par3EntityPlayer.addPotionEffect(new PotionEffect(
					Potion.resistance.id, 3600, 2, true));
			par3EntityPlayer.addPotionEffect(new PotionEffect(
					Potion.regeneration.id, 3600, 2, true));
			par3EntityPlayer.addPotionEffect(new PotionEffect(
					Potion.field_76443_y.id, 200, 2, true));
		}
