...
public class ItemTurquoiseBottle extends Item {
	public ItemTurquoiseBottle() {
		super();
		setUnlocalizedName("turquoisebottle");
	...
	public ItemStack onEaten(ItemStack par1ItemStack, World par2World,
		...
		if (!par2World.isRemote) {
			par3EntityPlayer.addPotionEffect(new PotionEffect(
					Potion.digSpeed.id, 6000, 1, true));
			par3EntityPlayer.addPotionEffect(new PotionEffect(
					Potion.nightVision.id, 6000, 1, true));
		}
