...
public class BlockMeatPurifier extends BlockContainer
{
	public BlockMeatPurifier()
	{
		super(Material.iron);
		setBlockName("meatpurifier");
	...
	{
		return new TileMeatPurifier();
	}

	@Override
	public boolean onBlockActivated(World par1World, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
	{
		TileMeatPurifier tEntity = (TileMeatPurifier) par1World.getTileEntity(x, y, z);
		if (tEntity != null)
		{
			player.openGui(ScorpMod.instance, 3, par1World, x, y, z);
			// }
			return true;
		}
		return false;
