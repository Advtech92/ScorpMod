...
public class BlockMixer extends BlockContainer
{
	...
	{
		this.side = reg.registerIcon(Reference.MOD_TEXTUREPATH + ":"
				+ (this.func_149739_a().substring(5)) + "sides");
		this.bottom = reg.registerIcon(Reference.MOD_TEXTUREPATH + ":"
				+ (this.func_149739_a().substring(5)) + "top");
		this.top = reg.registerIcon(Reference.MOD_TEXTUREPATH + ":"
				+ (this.func_149739_a().substring(5)) + "top");
		this.front = reg.registerIcon(Reference.MOD_TEXTUREPATH + ":"
				+ (this.func_149739_a().substring(5)) + "front");
	}
	...
	@Override
	public void func_149689_a(World par1World, int x, int y, int z,
	...
	@Override
	public boolean func_149727_a(World par1World, int x, int y, int z,
