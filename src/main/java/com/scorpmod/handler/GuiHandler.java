...
public class GuiHandler implements IGuiHandler{
        ...
        public Object getServerGuiElement(int ID, EntityPlayer player, World world,
                ...
                case 2: return new ContainerWasher((TileWasher) tile_entity, player.inventory);
                case 3: return new ContainerMeatPurifier((TileMeatPurifier) tile_entity, player.inventory);
        ...
        public Object getClientGuiElement(int ID, EntityPlayer player, World world,
                ...
                case 2: return new GuiWasher(player.inventory, (TileWasher) tile_entity);
                case 3: return new GuiMeatPurifier(player.inventory, (TileMeatPurifier) tile_entity);
